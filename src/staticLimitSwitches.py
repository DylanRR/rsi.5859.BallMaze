...
LS_BOTTOM_LEFT = 1              #Pin Label: CE0     Wire Color:Red
LS_CALIBRATE_LEFT = 2           #Pin Label: MISO    Wire Color:Red
LS_HORIZONTAL_RIGHT_INIT = 3   #Pin Label: MOSI    Wire Color:Red
LS_HORIZONTAL_RIGHT_STOP = 27   #Pin Label: SCLK    Wire Color:White
